                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center ">
                                        <h1 class="h4 text-gray-900 mb-4n  ">¡Actualizar informacion del Evento!</h1>
                                    </div>
                                    <Br>

                                    <form class="user" method="POST" action="{{url("/updateevents",$new->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col">
                                              ...
                                              <input type="text" class="form-control" value="{{$new->author}}" name="autor">
                                            </div>
                                        </div>
                                        <BR>
                                        <div class="row">
                                          ...
                                          <BR>
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" aria-label="With textarea" placeholder="{{$new->description}}" name="description"></textarea>
                                              </div>
                                                  <BR>
