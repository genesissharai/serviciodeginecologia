...
<head>
    ...
    <title>Hospital Raúl Leoni - Login</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{url("/$loginType")}}">
                                        {{ csrf_field() }}
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user"
                                                id="correo" aria-describedby="emailHelp" name="email"
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="{{url("/$registerType")}}">¡Registrarse!</a>
